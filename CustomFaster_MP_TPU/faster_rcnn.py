...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(
        ...
        rpn_head=None,
        rpn_pre_nms_top_n_train=300, #bloque modificado --> se han bajado el número de propuesta de train y test
        ...
        box_head=None,
        box_predictor=None,
        box_score_thresh=0.7, #bloque modificado --> se ha subido el score threshold
        box_nms_thresh=0.5,
